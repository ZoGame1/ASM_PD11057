...
public class ASM_MN : Singleton<ASM_MN>
{
	...
	public void YC1()
	{
		...
		Players player0 = new Players(id, "Nghĩa",50,new Region(2,"VN2"));
		listPlayer.Add(player0);

		Players player1 = new Players(id, "Nam", 100,new Region(3,"JS" ));
		listPlayer.Add(player1);

		Players player2 = new Players(id, "MY",200 ,new Region(4,"VN1"));
		listPlayer.Add(player2);

		
		Players player3 = new Players(id, "Huy", 300, new Region(5,"VS"));
		listPlayer.Add(player3);

		Region playerRegion1 = new Region(idR, regionName);
		Players player5 = new Players(id,name, score, playerRegion1);
